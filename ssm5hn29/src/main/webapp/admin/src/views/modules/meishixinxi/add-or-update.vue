<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="主料" prop="zhuliao">
          <el-input v-model="ruleForm.zhuliao" 
              placeholder="主料" clearable  :readonly="ro.zhuliao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主料" prop="zhuliao">
              <el-input v-model="ruleForm.zhuliao" 
                placeholder="主料" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/meishifenlei/leixing`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
	...
	this.ruleForm.meishijieshao = this.ruleForm.meishijieshao.replace(reg,'../../../ssm5hn29/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
